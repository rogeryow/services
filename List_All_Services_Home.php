        ...
        <div class="content-wrapper">
          ...
          <div class="row">
			...
			<div class = "box-area">
				...
				$query = "Select * From `tblservices` Where `Services_Desc` = 'Home' limit $start_from,$num_per_page";
				$result1 = mysqli_query($link,$query);	
				
				$sql = "SELECT * FROM `tblservices` ORDER BY `Services_Order` DESC";
				...
				echo "SQL statement failed";
					...
					while($row = mysqli_fetch_assoc($result1)){
						...
						$setCom = mysqli_num_rows($t);
							...
							//echo '<a href = "View_SP.php">'. $row['Company_Name'].'</a><br/><br/>';
			...
			<?php
					...
					echo '<br/>';
					if($page>1){
						echo "<a style = 'hover:blue' href = 'List_All_Services_Home.php?page=".($page-1)."' class = 'btn btn=primary'>Previous</a>";
					}
					
					for($i=1;$i<$total_pages;$i++){
						echo "<a style = 'hover:blue' href = 'List_All_Services_Home.php?page=".$i."' class = 'btn btn=primary'>$i</a>";
					}
					
					if($i>$page){
						echo "<a style = 'hover:blue' href = 'List_All_Services_Home.php?page=".($page+1)."' class = 'btn btn=primary'>Next</a>";
					}
					?>
          </div>
        <!-- partial -->
