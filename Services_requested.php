...
<body>
  <div class="container-scroller">
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2>Requesting Services List</h2>
                    <p class="mb-md-0">View your requesting services.</p>
                  </div>
                  <div class="d-flex">
	...
	<table id = "user">
			<tr>
				...
				<td>
					<h3 style = "font-family:arial"><label style = "margin-left:20px">Waiting for the approval from Services Provider</label></h3>
					<div class = "box-area">
					
		<?php
		$sql = $link->query("SELECT * FROM `tblrequestservices` WHERE `Username` = '$userWelcome' And `Status` = '0'" );
		$req_count = mysqli_num_rows($sql);
		echo "You have ".$req_count." requesting services";
				...
				<td>
					<div class = "box-area">
							<?php															
									...
									//echo $com = $services_req['SP_Name'];
									echo'</div>		
									</div>';					
							?>
							
							<td><a onclick = "javascript:confirmApproved(<?php echo $services_req['ID'];?>);">
							<input value = "Cancel" id  = "buttSearch" name = "btn_approved" type = "button" 
							title = "click to Approved..."></a>
							</td>
  ...
  <script type = "text/javascript">
		function confirmApproved(anchor){
			var config = confirm("Do you want to cancel this request?");
			if(config == true){
				window.location.href = "php_files/cancel_request.php?cd="+anchor;
			}else{
