        ...
        <div class="content-wrapper">
          ...
          <div class="row">
			...
			<div class = "box-area">
				...
				$query = "Select * From `tblservices` Where `Services_Desc` = 'Other' limit $start_from,$num_per_page";
			...
			<?php
					...
					echo '<br/>';
					if($page>1){
						echo "<a style = 'hover:blue' href = 'List_all_Services.php?page=".($page-1)."' class = 'btn btn=primary'>Previous</a>";
					}
					
					for($i=1;$i<$total_pages;$i++){
						echo "<a style = 'hover:blue' href = 'List_all_Services.php?page=".$i."' class = 'btn btn=primary'>$i</a>";
					}
					
					if($i>$page){
						echo "<a style = 'hover:blue' href = 'List_all_Services.php?page=".($page+1)."' class = 'btn btn=primary'>Next</a>";
					}
					?>
          </div>
        <!-- partial -->
