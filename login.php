                        ...
                        <div class="auth-form-transparent text-left p-3">
                            ...
                            <form method="Post" class="pt-3">
                                ...
                                <div class="text-center mt-4 font-weight-light">
                                    Create user account? <a href="../Version_1/client_Registration.php" class="text-primary">Create</a>
                                    <br/> Login as Service Provider? <a href="../client_Registration.php" class="text-primary">Login</a>
                                </div>
                            </form>
                        </div>
                    </div>
